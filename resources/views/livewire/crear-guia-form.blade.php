<form class="card-body d-flex flex-column align-items-center" action="{{ route('guias.store') }}" method="POST">
    @csrf
    <div class="col">
    ...
    <div class="col">
        <div class="col form-group d-flex flex-column justify-content-end ">
            ...
            <textarea value="{{ $observaciones }}" type="text" name="observaciones" id="observaciones"
